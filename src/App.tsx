...
export function App() {
  return (
    <div className='fixed left-0 right-0 top-0 bottom-0 overflow-auto pt-10 bg-gray-900 flex flex-col justify-center items-center text-gray-100'>
      ...
      <form className='flex flex-col gap-4 items-stretch w-full max-w-sm mt-10 px-2'>
      ...
      <footer className='flex flex-col items-center gap-4 mt-8 mb-6'>
